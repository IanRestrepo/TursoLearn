import { c as createComponent, r as renderTemplate, m as maybeRenderHead, a as addAttribute, b as createAstro, e as renderHead, f as renderSlot, g as renderComponent } from '../chunks/astro/server_DUtFgnab.mjs';
import 'kleur/colors';
import { d as db, C as Comment, A as Author } from '../chunks/_astro_db_COZSoCjb.mjs';
import 'clsx';
/* empty css                                 */
...
const astroLogo = new Proxy({"src":"/_astro/astro.Dm8K3lV8.svg","width":115,"height":48,"format":"svg"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/dev/AstroTurso/src/assets/astro.svg";
							}
...
const background = new Proxy({"src":"/_astro/background.BPKAcmfN.svg","width":1440,"height":1024,"format":"svg"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/dev/AstroTurso/src/assets/background.svg";
							}
...
}, "C:/dev/AstroTurso/src/components/Welcome.astro", void 0);
...
}, "C:/dev/AstroTurso/src/layouts/Layout.astro", void 0);
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, {}, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Welcome", $$Welcome, {})} ${maybeRenderHead()}<form method="POST" style="display: grid"> <label for="author">Author</label> <input type="number" name="author" id="author" required> <label for="content">Content</label> <textarea name="content" id="content" required></textarea> <button type="submit">Enviar</button> </form> <h2>Comments:</h2> ${comments?.map(({ Author: Author2, Comment: Comment2 }) => renderTemplate`<article> <p>Author: ${Author2.name}</p> <p>${Comment2.body}</p> </article>`)}` })}`;
}, "C:/dev/AstroTurso/src/pages/index.astro", void 0);

const $$file = "C:/dev/AstroTurso/src/pages/index.astro";
const $$url = "";
